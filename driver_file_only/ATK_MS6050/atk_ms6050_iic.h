...
/* 引脚定义 */
#define ATK_MS6050_IIC_SCL_GPIO_PORT            GPIOC
#define ATK_MS6050_IIC_SCL_GPIO_PIN             GPIO_PIN_12
#define ATK_MS6050_IIC_SCL_GPIO_CLK_ENABLE()    do{ __HAL_RCC_GPIOC_CLK_ENABLE(); }while(0)
#define ATK_MS6050_IIC_SDA_GPIO_PORT            GPIOD
#define ATK_MS6050_IIC_SDA_GPIO_PIN             GPIO_PIN_2
#define ATK_MS6050_IIC_SDA_GPIO_CLK_ENABLE()    do{ __HAL_RCC_GPIOD_CLK_ENABLE(); }while(0)
